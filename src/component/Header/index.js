          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                ...
                >
                  {basket.length ? (
                    <h1 className=" absolute right-[-13px] bottom-4 bg-red-800 w-5 h-5 rounded-[50%] flex items-center justify-center">
                      {basket.length}
                    </h1>
                  ) : null}
                  Basket
              ...
              <li>
                ...
                >
                  {favorite.length ? (
                    <h1 className=" absolute flex items-center justify-center bg-amber-400 w-5 h-5 rounded-[50%] right-[-13px] bottom-3">
                      {favorite.length}
                    </h1>
                  ) : null}
                  favorite
